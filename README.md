...
1. *If anyone finds this with an actual developer account feel free to upload it*
2. *There is currently a small bug when both automatic login and automatic theme are enabled at the same time, it will be fixed in the next version (2.01)*
